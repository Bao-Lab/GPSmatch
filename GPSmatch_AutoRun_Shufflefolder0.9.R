...
databaseFileSize(database_dir= "~/Desktop/AmyHighSchool/BaoNorthwestern/Col3DIR_SplitDataBase_mergeregions", "~/Desktop/AmyHighSchool/BaoNorthwestern/test")

file_list <- list.files(path="~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle.0.9.posDIR", pattern=".csv")
...
for (i in 1:length(file_list)){
  filename = paste("~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle.0.9.posDIR/",file_list[i], sep = "")
  print (filename)
  rankSimilarity(filename, "~/Desktop/AmyHighschool/BaoNorthwestern/Col3DIR_SplitDataBase_mergeregions","~/Desktop/AmyHighschool/BaoNorthwestern/Shuffle.0.9.posDIR_Result", "~/Desktop/AmyHighschool/BaoNorthwestern/Col3DIR_SplitDataBase_mergeregions_BindingSize.csv")
}


### Summary the top hit accuracy and their jaccard index value for all the simulation files
dffinal = c(rep(1:6))
file_list2 <- list.files(path="~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle.0.9.posDIR_Result")

for (i in 1:length(file_list2)){
  filename = paste("~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle.0.9.posDIR_Result/",file_list2[i], sep = "")
...
write.table(dffinal, file = "~/Desktop/AmyHighSchool/BaoNorthwestern/Summary_Shuffle.0.9.posDIR_Result_082621.csv")


###### negative 105 files
file_list <- list.files(path="~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle105.0.90.negDIR", pattern=".csv")
...
for (i in 1:length(file_list)){
  filename = paste("~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle105.0.90.negDIR/",file_list[i], sep = "")
  print (filename)
  rankSimilarity(filename, "~/Desktop/AmyHighschool/BaoNorthwestern/Col3DIR_SplitDataBase_mergeregions","~/Desktop/AmyHighschool/BaoNorthwestern/Shuffle105.0.90.negDIR_Result", "~/Desktop/AmyHighschool/BaoNorthwestern/Col3DIR_SplitDataBase_mergeregions_BindingSize.csv")
}

### Summary the top hit accuracy and their jaccard index value for all the simulation files
dffinal = c(rep(1:6))
file_list2 <- list.files(path="~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle105.0.90.negDIR_Result")

for (i in 1:length(file_list2)){
  filename = paste("~/Desktop/AmyHighSchool/BaoNorthwestern/Shuffle105.0.90.negDIR_Result/",file_list2[i], sep = "")
...
write.table(dffinal, file = "~/Desktop/AmyHighSchool/BaoNorthwestern/Summary_Shuffle105.0.90.negDIR_Result_082621.csv")
...
###Note: In the database we used, some BED files only have one or two lines of binding sites. If those files were randomly chosen to create shuffled file, we will remove those files as shuffled files,
### The reason is that with such small number of lines, it is impossible to get 10%, 20% ...accurate shuffling. For example, if there are only two lines, the shuffled file must have 100% , 50% or 0% shuffling.
